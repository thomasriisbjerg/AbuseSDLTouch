...
;; Weitere Einzelheiten zu den Benutzerrechten unter Lizenzrechte. 
	 ...
	 (setq space_cont "Ber¸hren Sie Bildschirm, um fortzufahren ")        ; V-E
	 ...
	 (setq loading "LÑdt %s")  ; V-A added
         ...
         (defun get_train_msg (message_num)
           (select message_num    
                   ...
                   (5 "DrÅcken Sie spezielle Power-Symbol, um spezielle KrÑfte zu wechseln")
                   ;(6 "Mit STRG oder EINFG wÑhlen Sie Waffen aus.")
                   (6 "DrÅcken Waffe icons Waffen wechseln")
